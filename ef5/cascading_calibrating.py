...
def update_vals(row, data=res1):
    if row.gauge == data['gauge']:
		row.alpha0 = data['alpha0']
		row.b = data['b']
		row.ke = data['ke']
		row.wm = data['wm']
		row.leaki = data['leaki']
		row.beta = data['beta']
		row.fc = data['fc']
		row.im = data['im']
		row.th = data['th']
		row.under = data['under']
		row.alpha = data['alpha']
		row.alpha_inun = data['alpha0']
    return row
